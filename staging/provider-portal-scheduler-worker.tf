module "provider-portal-scheduler-worker" {
  source                          = "../modules//aws_worker/"
  project                         = var.project
  cluster_id                      = module.ecs.cluster_ids[0]
  service_name                    = "provider-portal-scheduler-worker"
...
output "provider-portal-scheduler-worker-task-definition-json" {
  value = module.provider-portal-scheduler-worker.task_definition_json
}

module "marketplace-rq-scheduler-worker" {
  source                          = "../modules//aws_worker/"
  project                         = var.project
  cluster_id                      = module.ecs.cluster_ids[0]
  service_name                    = "marketplace-rq-scheduler-worker"
  ...
  cmd                             = "[\"rq\", \"worker\", \"-c\", \"marketplace.settings_rq_worker_scheduling\", \"--sentry-dsn\", \"\", \"--exception-handler\", \"marketplace.rq_exception_handlers.handle_exception\"]"
...
output "marketplace-rq-scheduler-worker-task-definition-json" {
  value = module.marketplace-rq-scheduler-worker.task_definition_json
}
